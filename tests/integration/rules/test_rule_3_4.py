...
from prozorro.risks.rules.risk_3_4 import RiskRule
...
@patch("prozorro.risks.rules.risk_3_4.fetch_tender", return_value=tender_data)
...
@patch("prozorro.risks.rules.risk_3_4.fetch_tender")
