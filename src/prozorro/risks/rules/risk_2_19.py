        ...
        if (
            ...
            if len(tender.get("lots", 0)):
                ...
                for lot in tender["lots"]:
                    ...
                    if disqualified_lots_count == lots_limit and related_active_bid_count > disqualified_lots_count + 2:
                        return RiskIndicatorEnum.risk_found
            else:
                if len(unsuccessful_awards) == lots_limit and len(active_bids) > len(unsuccessful_awards) + 2:
                    return RiskIndicatorEnum.risk_found
